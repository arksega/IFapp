...
{
	/**
	 * @var private property containing the associated Question model instance
	...
	/**
	 * Ensure question context
	 */
	public function filterProjectContext($filterChain)
	{
		if(isset($_GET['qid'])) {
			if($this->_question===null) {
				$this->_question=Question::model()->findByPk($_GET['qid']);
				if($this->_question===null)
	...
	{
		$model=new Answer;
		$model->id_question=$this->_question->id;
		...
		if(isset($_POST['Answer']))
		{
			...
			if($model->save())
				$this->redirect(array('/question/update','id'=>$model->id_question));
		}
